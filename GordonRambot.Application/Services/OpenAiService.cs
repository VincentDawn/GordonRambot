...
namespace GordonRambot.Services.Services
{
    public class OpenAiService : IApiClient
    {
        ...
        public OpenAiService(IOptions<OpenAiServiceSettings> options)
        {
            ...
            this.openAIClient = new OpenAIClient(uri, credentials);
        }
        ...
        public Task<RecipeInformationFromRecipeResponse?> GetRecipeInformation(RecipeInformationFromRecipeRequest request)
        {
            throw new NotImplementedException();
        }
    }
